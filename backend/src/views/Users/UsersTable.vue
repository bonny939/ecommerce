<template>
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down" v-if="$can('view-system-users')">
      ...
      <tr v-for="(user, index) of users.data">
        ...
        <td class="border-b p-2 ">
          <Menu as="div" class="relative inline-block text-left">
            <div>
              <MenuButton v-if="$can('create-system-users')"
            ...
            >
              <MenuItems v-if="$can('create-system-users')"
